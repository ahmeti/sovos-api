...
class MMService extends Service
{
    protected string $url_test = 'https://earsivwstest.fitbulut.com/ClientEMmServicesPort.svc';

    protected string $url_prod = 'https://earsivws.fitbulut.com/ClientEMmServicesPort.svc';
